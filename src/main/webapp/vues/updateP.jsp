...
<input type=text name=nom required class="form-control car" value =${produit.nom }>
 <span  class="bg-danger" text =white><form:errors path="produit.nom"></form:errors></span>
</div>
<div>
<label class="form-label">Prix</label>
<input type=number name=prix required class="form-control car" value=${produit.prix }>
</div>
<div>
<label class="form-label">Quantite</label>
<input name=quantite type=number required="required" class="form-control car" value=${produit.quantite }><br>
</div>
<div>
...
<c:forEach items="${categories}" var="x">
 ...
 <a href="categories/all" class="btn btn-danger">Ajouter Categorie</a><br>
<br>
</div>
